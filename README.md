...
This project uses **Multi-Agent Deep Deterministic Policy Gradient** ([MADDPG](https://arxiv.org/abs/1706.02275)) algorithm to train two agents to control rackets to bounce a ball over a net.

![Trained Agent](assets/trained.gif)
